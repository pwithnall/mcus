...
enum {
	...
	MCUS_COMPILER_ERROR_INVALID_DIRECTIVE_NAME,
	MCUS_COMPILER_ERROR_INVALID_DIRECTIVE_DELIMITATION,
...
GType mcus_compiler_get_type (void);
GQuark mcus_compiler_error_quark (void);

MCUSCompiler *mcus_compiler_new (void);
